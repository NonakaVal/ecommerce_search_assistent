...
from crews.target_audience import create_target_audience_analysis_team
    ...
    if st.button("Executar Pesquisa"):
        ...
        with st.expander("Processando!"):
            ...
            with st.spinner("Gerando Resultados"):
                crew_result = create_target_audience_analysis_team(product_name=product_name, llm=llm)
        # Parar o cronômetro
        end_time = time.time()
