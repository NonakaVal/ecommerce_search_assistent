...
from crews.product_detail import create_and_execute_related_products_research_team
    ...
    if st.button("Executar Pesquisa"):
        ...
        with st.expander("Processando!"):
            ...
            with st.spinner("Gerando Resultados"):
                crew_result = create_and_execute_related_products_research_team(product_name=product_name, llm=llm)
        # Parar o cronômetro
        end_time = time.time()
